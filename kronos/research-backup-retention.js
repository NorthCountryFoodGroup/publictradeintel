...
const VERSION="KRONOS_RETENTION_REQUIREMENT_V1";
...
function validate(r){
 c.shape(r,"retentionVersion,policyId,artifactClass,approvedAt,minimumRetainUntil,approval,productionApproved,policyHash");
...
function fixtureRequirement(policyId,approvedAt,evidenceDays){
