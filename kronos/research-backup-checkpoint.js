...
function validateReference(ref,context,kind){c.shape(ref,"descriptor,locator");c.descriptor(ref.descriptor);c.sameContext(ref.descriptor,context);c.shape(ref.locator,"environmentId,streamId,objectKey,versionId");c.sameContext(ref.locator,context);c.label(ref.locator.versionId);c.check(ref.locator.objectKey===ref.descriptor.objectKey&&(!kind||ref.descriptor.artifactType===kind));return ref;}
