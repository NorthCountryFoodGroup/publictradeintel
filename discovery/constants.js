...
const DISCOVERY_READINESS_HISTORY_VERSION = "v3-readiness-history-1";
const DISCOVERY_READINESS_OBSERVATION_VERSION = "v3-readiness-observation-1";
const DISCOVERY_READINESS_HISTORY_FILENAME = "discoveryReadinessHistory.json";
const DISCOVERY_READINESS_OBSERVATION_MAX_BYTES = 8192;
