...
assert.match(server, /function marketDataAvailabilityFromCoverage/, "unavailable data should use critical-field coverage thresholds");
assert.match(server, /percent < 40[\s\S]*"Unavailable"/, "unavailable data should require below-40% critical-field coverage");
assert.match(server, /percent < 90[\s\S]*"Partial"/, "70-89.99% coverage should be partial, not unavailable");
