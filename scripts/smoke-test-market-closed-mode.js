...
assert.match(server, /Closed - Market Holiday/, "server should identify market holidays");
...
assert.match(app, /Live intraday market data is unavailable/, "UI should explain closed-market data behavior");
