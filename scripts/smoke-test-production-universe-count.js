...
assert.match(server, /savedStatus\.usable && !savedIsEmergency/, "saved universe should only win when it is broad, fresh, and valid");
assert.match(server, /persistSymbolUniverse\(packaged\)/, "valid packaged snapshot should replace undersized saved universe and seed persistent storage");
