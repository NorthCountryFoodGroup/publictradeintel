...
assert.match(server, /withCriticalPercent < 40[\s\S]*"Unavailable"/, "unavailable should require below-threshold critical coverage");
assert.match(server, /withCriticalPercent < 70[\s\S]*"Degraded"/, "degraded threshold should exist");
assert.match(server, /withCriticalPercent < 90[\s\S]*"Partial"/, "partial threshold should exist");
assert.match(server, /withCriticalPercent < 95[\s\S]*"Good"/, "good threshold should exist");
